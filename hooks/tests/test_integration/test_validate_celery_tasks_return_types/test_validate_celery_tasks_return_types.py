...
def mocked_get_input_files(mocker):
    return mocker.patch('hooks.validate_celery_tasks_return_types.get_input_files')


def test_failing_file(mocked_get_input_files, capsys):
    mocked_get_input_files.return_value = [SAMPLES_DIR / 'tasks_with_incorrect_return_types.py']
...
def test_passing_file(mocked_get_input_files):
    mocked_get_input_files.return_value = [SAMPLES_DIR / 'tasks_with_correct_return_types.py']
